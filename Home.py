...
with st.container():
    ...
    with left_column:
       ...
       st.markdown(
        f'<a href="{linkedin_url}" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" width="30" style="vertical-align: middle;"> LinkedIn Profile</a>', 
        unsafe_allow_html=True
        )
