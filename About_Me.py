...
st.markdown(
    ...
    "<div style='margin: 5px; flex-basis: 50%; display: flex; justify-content: space-around;'>"
    "<div style='display: flex; flex-direction: column;'>"
    ...
    "</div>"
    "<div style='display: flex; flex-direction: column;'>"
    "<img src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg' alt='js' style='width: 50px; height: 50px;'>"
    ...
    "<div style='margin: 5px; flex-basis: 50%; display: flex; justify-content: space-around;'>"
    "<div style='display: flex; flex-direction: column;'>"
    "<img src='https://icon.icepanel.io/Technology/svg/scikit-learn.svg' alt='skl' style='width: 50px; height: 50px;'>"
    "<p style='margin: 5px 0;'>scikit-learn</p>"
    "</div>"
    "<div style='display: flex; flex-direction: column;'>"
    "<img src='https://www.statsmodels.org/stable/_images/statsmodels-logo-v2-no-text.svg' alt='stats' style='width: 50px; height: 50px;'>"
    "<p style='margin: 5px 0;'>statsmodels</p>"
    "</div>"
    "</div>"
    "</div>"
    "</div>"
