...
with journey:
    ...
    st.write("IIn my sophomore year of 2020, a friend from my data mining class, who had recently transitioned from finance, introduced me to the intricate world of financial markets and trading. With COVID-19 disrupting internship opportunities that summer, I seized the chance to collaborate with a diverse group of friends, including computer scientists, mathematicians, and 
    finance majors, totaling six people. Throughout the summer, we immersed ourselves in understanding the nuances of foreign exchange markets, leveraging trading software, and conducting extensive research. Our journey involved delving into countless papers on time series analysis, statistical methods, and advanced techniques such as Hidden Markov Models, Natural Language
    Processing for text processing, and Kalman filters. Each week, we met for hours, synthesizing insights and devising strategies to exploit arbitrage opportunities arising from currency mispricing. Our process was rigorous, involving numerous backtests and learning from mistakes along the way.
