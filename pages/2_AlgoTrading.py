...
with journey:
    ...
    finance majors, totaling six people. Throughout the summer, we immersed ourselves in understanding the nuances of foreign exchange markets, leveraging trading software, and conducting extensive research. Our journey involved delving into countless papers that summer to find things that could better our stratgies. Papers on time series helped us understand ditrubtiuon shitsfs, autoregressive quilites, statistical methods for hypothysis tetsing, volotilty clustering for risk mangemnt adn the overall random natruer of financial assets. Other research lead us to learning about Hidden Markov Models for risk modeling, Natural Language
